...
a = Vector(1, 0, 0)
A = viewer.add(Line(point, a), color=(0, 0, 0), linewidth=3)

b = Vector(1, 0, 0)
B = viewer.add(Line(point, b), color=(0, 0, 0), linewidth=3)

ab = a + b

axb = a.cross(b)
AXB = viewer.add(Line(point, axb), color=(1, 0, 0), linewidth=3)
