...
axb = a.cross(b)
poly = Polygon([point, a, b])

print(0.5 * axb.length == poly.area)
print(axb.dot([0, 0, 1]) > 0)
...
viewer.add(Line(point, axb), color=(1, 0, 0) if axb[2] > 0 else (0, 0, 1), linewidth=5)
viewer.add(poly, show_face=True, facecolor=(1, 0, 0) if axb[2] > 0 else (0, 0, 1), opacity=0.3)
